...
def _create_subfolder(ztfname, filtercode, sciimg_filename, args):
...
def main():
    ...
    for ztfname in ztfnames:
        ...
        def _create_subfolders(filtercode, hdfstore):
            ...
            joblib.Parallel(n_jobs=args.n_jobs)(joblib.delayed(_create_subfolder)(ztfname, filtercode, sciimg_filename, args) for sciimg_filename in lc_df['ipac_file'].tolist())
